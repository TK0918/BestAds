const adReviewPageRoot = document.getElementById('page-root');
if (adReviewPageRoot) {
  adReviewPageRoot.classList.add('ad-review-root', 'bg-gray-50');
  adReviewPageRoot.innerHTML = String.raw`        <div class="py-6">
...
`;
  document.body.insertAdjacentHTML('beforeend', String.raw`  <!-- 详情模态框 -->
