    ...
    'bind-card-account': {
      ...
      tabs: [
        ...
        },
        {
          id: 'transfer-records',
          label: '额度转移记录',
          filters: [{ key: 'transferOrderId', label: '转移单号', placeholder: '输入转移单号' }, { key: 'transferStatus', label: '处理状态', type: 'select', options: ['处理中', '转出降额失败', '转入升额失败', '退回中', '退回失败', '已成功', '已取消', '已退回'], placeholder: '选择处理状态' }, { key: 'accountId', label: '广告账户ID', placeholder: '输入广告账户ID' }, { key: 'merchantId', label: '商户ID', placeholder: '输入商户ID' }, { key: 'customerName', label: '客户名称', placeholder: '输入客户名称' }, { key: 'fromCardId', label: '转出卡ID', placeholder: '输入转出卡ID' }, { key: 'toCardId', label: '转入卡ID', placeholder: '输入转入卡ID' }, { key: 'updatedAt', label: '更新时间', type: 'daterange' }],
          actions: [exportAction],
          filterClass: 'cols-5',
          hideExtraDetailFields: true,
          tableMinWidth: 2560,
          opsWidth: 360,
          columns: columns(['转移单号', '处理状态', '广告账户ID', '广告账户名称', '商户ID', '客户名称', '转出卡', '转入卡', '转移金额', '转出降额', '转入升额', '待处理金额', '失败原因 / 当前处理', '锁定状态', '最后处理人', '更新时间'], { left: ['广告账户名称', '客户名称', '转出卡', '转入卡', '失败原因 / 当前处理', '最后处理人'], person: ['最后处理人'], status: ['处理状态', '转出降额', '转入升额', '锁定状态'], widths: [170, 140, 180, 210, 100, 180, 250, 250, 120, 130, 130, 130, 300, 160, 240, 170] }),
          rows: [
            row(['TR20260811001', '处理中', '973462981122', 'G-Alpha-042', '14229', 'test金额变动', 'c_w9x8y7z6v5u4t3(5678)', 'c_3bpoltc2u7sf1(7209)', '80.00 USD', '降额中', '待开始', '80.00 USD', 'Fund 已接收请求，等待转出卡降额结果', '转出卡/转入卡锁定', '李彦(liyan@bestfulfill.com)', '2026-08-11 10:42:18'], { transferOrderId: 'TR20260811001', transferStatus: '处理中', accountId: '973462981122', merchantId: '14229', customerName: 'test金额变动', fromCardId: 'c_w9x8y7z6v5u4t3', toCardId: 'c_3bpoltc2u7sf1', updatedAt: '2026-08-11 10:42:18', ops: ['查看转移履历'], transferLogs: [{ at: '2026-08-11 10:42:18', operator: '李彦(liyan@bestfulfill.com)', action: '发起额度转移', status: '处理中', detail: '转出 c_w9x8y7z6v5u4t3(5678)，转入 c_3bpoltc2u7sf1(7209)，金额 80.00 USD' }, { at: '2026-08-11 10:42:26', operator: '系统', action: '提交转出降额', status: '处理中', detail: 'Fund 已接收请求，等待转出卡降额结果' }] }),
            row(['TR20260811002', '转出降额失败', '821285917232112', 'HQ-W-12-13', '1128', 'adstest', 'c_6b4m32v9ab21(1288)', 'c_2dsw82249hx2s(0751)', '120.00 USD', '失败', '未开始', '0.00 USD', 'Fund 返回：Slash 降额失败，转出卡额度未变化', '未锁定', '张三(zhangsan@bestfulfill.com)', '2026-08-11 09:18:42'], { transferOrderId: 'TR20260811002', transferStatus: '转出降额失败', accountId: '821285917232112', merchantId: '1128', customerName: 'adstest', fromCardId: 'c_6b4m32v9ab21', toCardId: 'c_2dsw82249hx2s', updatedAt: '2026-08-11 09:18:42', ops: ['重试转出', '取消转移', '查看转移履历'], transferLogs: [{ at: '2026-08-11 09:12:01', operator: '张三(zhangsan@bestfulfill.com)', action: '发起额度转移', status: '处理中', detail: '转出 c_6b4m32v9ab21(1288)，转入 c_2dsw82249hx2s(0751)，金额 120.00 USD' }, { at: '2026-08-11 09:18:42', operator: 'Fund 回调', action: '转出降额失败', status: '转出降额失败', detail: 'Slash 降额失败，转出卡额度未变化' }] }),
            row(['TR20260811003', '转入升额失败', '973462981122', 'G-Alpha-042', '14229', 'test金额变动', 'c_3bpoltc2u7sf1(7209)', 'c_w9x8y7z6v5u4t3(5678)', '500.00 USD', '成功', '失败', '500.00 USD', '转出卡已降额，转入卡升额失败；可退回、重试或换转入卡重试', '转出卡额度锁定', '李彦(liyan@bestfulfill.com)', '2026-08-11 09:06:12'], { transferOrderId: 'TR20260811003', transferStatus: '转入升额失败', accountId: '973462981122', merchantId: '14229', customerName: 'test金额变动', fromCardId: 'c_3bpoltc2u7sf1', toCardId: 'c_w9x8y7z6v5u4t3', updatedAt: '2026-08-11 09:06:12', ops: ['重试转入', '换转入卡重试', '退回转出卡', '查看转移履历'], transferLogs: [{ at: '2026-08-11 08:59:35', operator: '李彦(liyan@bestfulfill.com)', action: '发起额度转移', status: '处理中', detail: '转出 c_3bpoltc2u7sf1(7209)，转入 c_w9x8y7z6v5u4t3(5678)，金额 500.00 USD' }, { at: '2026-08-11 09:00:18', operator: 'Fund 回调', action: '转出降额成功', status: '处理中', detail: '转出卡已降额，待处理金额 500.00 USD' }, { at: '2026-08-11 09:06:12', operator: 'Fund 回调', action: '转入升额失败', status: '转入升额失败', detail: '转入卡升额失败，可重试转入、换转入卡重试或退回转出卡' }] }),
            row(['TR20260810012', '退回失败', '1587676814', 'silixwear-MH-0121', '10152', '电商三组（Mindxis）', 'c_close_4821(4821)', 'c_backup_7782(7782)', '1,500.00 USD', '成功', '未升额', '1,500.00 USD', '退回原转出卡失败；仍可继续转入当前卡、换转入卡或重试退回', '转出卡额度锁定', '汤秀梅(tangxiumei@bestfulfill.com)', '2026-08-10 18:25:30'], { transferOrderId: 'TR20260810012', transferStatus: '退回失败', accountId: '1587676814', merchantId: '10152', customerName: '电商三组', fromCardId: 'c_close_4821', toCardId: 'c_backup_7782', updatedAt: '2026-08-10 18:25:30', ops: ['重试转入', '换转入卡重试', '重试退回', '查看转移履历'], transferLogs: [{ at: '2026-08-10 17:55:10', operator: '汤秀梅(tangxiumei@bestfulfill.com)', action: '发起额度转移', status: '处理中', detail: '转出 c_close_4821(4821)，转入 c_backup_7782(7782)，金额 1,500.00 USD' }, { at: '2026-08-10 17:56:04', operator: 'Fund 回调', action: '转出降额成功', status: '处理中', detail: '转出卡已降额，待处理金额 1,500.00 USD' }, { at: '2026-08-10 18:03:27', operator: 'Fund 回调', action: '转入升额失败', status: '转入升额失败', detail: '转入卡升额失败，运营选择退回转出卡' }, { at: '2026-08-10 18:16:49', operator: '汤秀梅(tangxiumei@bestfulfill.com)', action: '退回转出卡', status: '退回中', detail: '提交 Fund 加回转出卡请求' }, { at: '2026-08-10 18:25:30', operator: 'Fund 回调', action: '退回失败', status: '退回失败', detail: '加回原转出卡失败，仍可重试转入、换转入卡重试或重试退回' }] }),
            row(['TR20260810008', '已成功', '973462981122', 'G-Alpha-042', '14229', 'test金额变动', 'c_w9x8y7z6v5u4t3(5678)', 'c_3bpoltc2u7sf1(7209)', '200.00 USD', '成功', '成功', '0.00 USD', '转出降额和转入升额均完成，已写权限审计', '未锁定', '管理员(admin@bestfulfill.com)', '2026-08-10 14:11:28'], { transferOrderId: 'TR20260810008', transferStatus: '已成功', accountId: '973462981122', merchantId: '14229', customerName: 'test金额变动', fromCardId: 'c_w9x8y7z6v5u4t3', toCardId: 'c_3bpoltc2u7sf1', updatedAt: '2026-08-10 14:11:28', ops: ['查看转移履历'], transferLogs: [{ at: '2026-08-10 14:08:02', operator: '管理员(admin@bestfulfill.com)', action: '发起额度转移', status: '处理中', detail: '转出 c_w9x8y7z6v5u4t3(5678)，转入 c_3bpoltc2u7sf1(7209)，金额 200.00 USD' }, { at: '2026-08-10 14:09:11', operator: 'Fund 回调', action: '转出降额成功', status: '处理中', detail: '转出卡降额成功' }, { at: '2026-08-10 14:11:28', operator: 'Fund 回调', action: '转入升额成功', status: '已成功', detail: '转出降额和转入升额均完成，已写权限审计' }] }),
            row(['TR20260810002', '已取消', '821285917232112', 'HQ-W-12-13', '1128', 'adstest', 'c_6b4m32v9ab21(1288)', 'c_2dsw82249hx2s(0751)', '50.00 USD', '未降额', '未升额', '0.00 USD', '转出卡降额失败后，业务取消该笔转移', '未锁定', '张三(zhangsan@bestfulfill.com)', '2026-08-10 11:43:09'], { transferOrderId: 'TR20260810002', transferStatus: '已取消', accountId: '821285917232112', merchantId: '1128', customerName: 'adstest', fromCardId: 'c_6b4m32v9ab21', toCardId: 'c_2dsw82249hx2s', updatedAt: '2026-08-10 11:43:09', ops: ['查看转移履历'], transferLogs: [{ at: '2026-08-10 11:31:22', operator: '张三(zhangsan@bestfulfill.com)', action: '发起额度转移', status: '处理中', detail: '转出 c_6b4m32v9ab21(1288)，转入 c_2dsw82249hx2s(0751)，金额 50.00 USD' }, { at: '2026-08-10 11:38:47', operator: 'Fund 回调', action: '转出降额失败', status: '转出降额失败', detail: '转出卡降额失败，额度未变化' }, { at: '2026-08-10 11:43:09', operator: '张三(zhangsan@bestfulfill.com)', action: '取消转移', status: '已取消', detail: '转出未成功，关闭该转移单' }] })
          ],
          modals: {
            '重试转出': { type: 'confirm', title: '重试转出卡降额', copy: '该操作只会重试转出卡降额步骤，不会创建新的额度转移单。确认重试？' },
            '取消转移': { type: 'confirm', title: '取消额度转移', copy: '仅转出卡未降额成功时允许取消。确认取消后，该转移单关闭且不再调 Fund。', danger: true },
            '重试转入': { type: 'confirm', title: '重试转入卡升额', copy: '转出卡已降额，本次只重试转入卡升额，不会再次降低转出卡额度。确认重试？' },
            '退回转出卡': { type: 'confirm', title: '退回转出卡', copy: '确认不再继续转入，将待处理额度加回转出卡？退回完成前相关卡仍保持额度操作锁定。', danger: true },
            '重试退回': { type: 'confirm', title: '重试退回转出卡', copy: '该操作会再次调用 Fund 将待处理额度加回转出卡。确认重试？' },
            '换转入卡重试': { title: '换转入卡重试', fields: [{ key: 'newToCard', label: '新的转入卡', control: 'select', options: ['c_new_4501(4501)｜正常｜同广告账户', 'c_new_9022(9022)｜正常｜同广告账户'], placeholder: '选择同广告账户正常卡' }, { key: 'remark', label: '备注', control: 'textarea', full: true, required: false, placeholder: '说明更换转入卡原因，原型会保留处理记录。' }] }
          }
        },
        {
          id: 'audit',
