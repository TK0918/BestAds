  ...
  const reportConfigs = {
    ...
    'bind-card-account': {
      ...
      tabs: [
        {
          ...
          rows: [
            row(['账户行', 'Facebook', '821285917232112', 'HQ-W-12-13', '1128', 'adstest', '3', '待验卡·请去媒体', 'c_2dsw82249hx2s', '0751', 'USD', '519.00', '张三(zhangsan@bestfulfill.com)', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '2026-08-08 10:11:02'], { media: 'Facebook', accountId: '821285917232112', accountName: 'HQ-W-12-13', merchantId: '1128', customerName: 'adstest', verifyStatus: '待验卡', ops: ['修改使用卡', '额度转移', '验卡任务详情'] }),
            row(['卡行', 'Facebook', '821285917232112', 'HQ-W-12-13', '1128', 'adstest', '-', '-', '-', '-', '-', '-', '张三(zhangsan@bestfulfill.com)', 'c_2dsw82249hx2s', '0751', 'USD', '520.00', '1.00', '519.00', '正常', '是', '519.00 USD', '待验卡', '2026-08-08 10:11:02'], { media: 'Facebook', accountId: '821285917232112', accountName: 'HQ-W-12-13', merchantId: '1128', customerName: 'adstest', cardId: 'c_2dsw82249hx2s', cardLast4: '0751', cardStatus: '正常', isUsing: '是', verifyStatus: '待验卡', ops: ['验卡任务详情', '标记媒体已验证', '取消任务', '查看完整卡信息', '转出额度'] }),
            row(['卡行', 'Facebook', '821285917232112', 'HQ-W-12-13', '1128', 'adstest', '-', '-', '-', '-', '-', '-', '张三(zhangsan@bestfulfill.com)', 'c_6b4m32v9ab21', '1288', 'USD', '300.00', '42.00', '258.00', '正常', '否', '-', '未申请', '2026-08-07 16:24:55'], { media: 'Facebook', accountId: '821285917232112', accountName: 'HQ-W-12-13', merchantId: '1128', customerName: 'adstest', cardId: 'c_6b4m32v9ab21', cardLast4: '1288', cardStatus: '正常', isUsing: '否', verifyStatus: '未申请', ops: ['申请验卡初始额度', '查看完整卡信息', '解绑', '冻结卡', '转出额度'] }),
            ...
            row(['账户行', 'Google', '973462981122', 'G-Alpha-042', '14229', 'test金额变动', '2', '已验卡·可充值', 'c_3bpoltc2u7sf1', '7209', 'USD', '498.00', '李彦(liyan@bestfulfill.com)', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '2026-08-08 18:42:31'], { media: 'Google', accountId: '973462981122', accountName: 'G-Alpha-042', merchantId: '14229', customerName: 'test金额变动', verifyStatus: '已验卡(未回收)', ops: ['修改使用卡', '额度转移', '验卡任务详情'] }),
            row(['卡行', 'Google', '973462981122', 'G-Alpha-042', '14229', 'test金额变动', '-', '-', '-', '-', '-', '-', '李彦(liyan@bestfulfill.com)', 'c_3bpoltc2u7sf1', '7209', 'USD', '500.00', '2.00', '498.00', '正常', '是', '499.00 USD', '已验卡(未回收)', '2026-08-08 18:42:31'], { media: 'Google', accountId: '973462981122', accountName: 'G-Alpha-042', merchantId: '14229', customerName: 'test金额变动', cardId: 'c_3bpoltc2u7sf1', cardLast4: '7209', cardStatus: '正常', isUsing: '是', verifyStatus: '已验卡(未回收)', ops: ['验卡任务详情', '确认验卡退款并回收', '查看完整卡信息', '转出额度'] }),
            row(['卡行', 'Google', '973462981122', 'G-Alpha-042', '14229', 'test金额变动', '-', '-', '-', '-', '-', '-', '李彦(liyan@bestfulfill.com)', 'c_w9x8y7z6v5u4t3', '5678', 'USD', '200.00', '0.00', '200.00', '正常', '否', '-', '已回收', '2026-08-05 09:10:20'], { media: 'Google', accountId: '973462981122', accountName: 'G-Alpha-042', merchantId: '14229', customerName: 'test金额变动', cardId: 'c_w9x8y7z6v5u4t3', cardLast4: '5678', cardStatus: '正常', isUsing: '否', verifyStatus: '已回收', ops: ['查看完整卡信息', '解绑', '冻结卡', '转出额度'] }),
            ...
            row(['卡行', 'AppLovin', '1587676814', 'silixwear-MH-0121', '10152', '电商三组（Mindxis）', '-', '-', '-', '-', '-', '-', '汤秀梅(tangxiumei@bestfulfill.com)', 'c_close_4821', '4821', 'USD', '520.00', '422.00', '98.00', '正常', '是', '20.00 USD', '已充值关单(未回收)', '2026-08-08 20:16:09'], { media: 'AppLovin', accountId: '1587676814', accountName: 'silixwear-MH-0121', merchantId: '10152', customerName: '电商三组', cardId: 'c_close_4821', cardLast4: '4821', cardStatus: '正常', isUsing: '是', verifyStatus: '已充值关单(未回收)', ops: ['验卡任务详情', '确认验卡退款并回收', '查看完整卡信息'] }),
            ...
            row(['卡行', '其他', 'OT-3301991', 'Other-Media-330', '13052', 'T&L', '-', '-', '-', '-', '-', '-', '张三(zhangsan@bestfulfill.com)', 'c_fail_6640', '6640', 'USD', '420.00', '419.50', '0.50', '正常', '是', '419.00 USD', '回收失败', '2026-08-08 09:47:04'], { media: '其他', accountId: 'OT-3301991', accountName: 'Other-Media-330', merchantId: '13052', customerName: 'T&L', cardId: 'c_fail_6640', cardLast4: '6640', cardStatus: '正常', isUsing: '是', verifyStatus: '回收失败', ops: ['验卡任务详情', '确认验卡退款并回收', '查看完整卡信息'] })
          ]
        },
        {
          id: 'check',
      ...
      modals: {
        ...
        '确认验卡退款并回收': { title: '确认验卡退款并回收', fields: [{ key: 'snapshot', label: '回收预检', control: 'textarea', full: true, required: false, placeholder: '展示当前总额 / 已用 / 可用与回收目标；可用不足时拦截。' }, { key: 'slashTxnId', label: 'Slash交易号', required: false, placeholder: '选填' }, { key: 'remark', label: '备注', control: 'textarea', full: true, required: false, placeholder: '选填' }] },
        '额度转移': { title: 'Slash 额度转移', fields: [{ key: 'fromCard', label: '转出卡', control: 'select', options: ['c_6b4m32v9ab21(1288) 可转 258.00 USD', 'c_3bpoltc2u7sf1(7209) 可转 498.00 USD', 'c_w9x8y7z6v5u4t3(5678) 可转 199.00 USD'], placeholder: '选择同账户正常卡' }, { key: 'toCard', label: '转入卡', control: 'select', options: ['c_w9x8y7z6v5u4t3(5678)', 'c_6b4m32v9ab21(1288)', 'c_3bpoltc2u7sf1(7209)'], placeholder: '选择同账户其他正常卡' }, { key: 'amount', label: '转移金额', placeholder: '≤ 可转上限，保留 $1 底线' }, { key: 'warning', label: '未回收提醒', control: 'textarea', full: true, required: false, placeholder: '转出卡存在未回收验卡额度时强提醒，但不拦截提交。' }] },
        '转出额度': { title: '转出额度', fields: [{ key: 'fromCard', label: '转出卡', placeholder: '当前卡自动预填' }, { key: 'toCard', label: '转入卡', control: 'select', options: ['c_w9x8y7z6v5u4t3(5678)', 'c_6b4m32v9ab21(1288)', 'c_3bpoltc2u7sf1(7209)'], placeholder: '选择同账户其他正常卡' }, { key: 'amount', label: '转移金额', placeholder: '≤ min(可用, 总额 - $1)' }] },
