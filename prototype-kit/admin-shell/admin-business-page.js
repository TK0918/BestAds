...
(function () {
  ...
  const openingCategoryValues = ['健身与运动', '母婴与亲子', '时尚与服装', '户外园艺与 DIY', '玩具与游戏', '宠物用品', '电子产品与智能设备', '美妆与个护', '汽配与工具', '珠宝腕表与配饰', '家居厨房与生活', '口服健康保健与营养', '非口服健康保健与营养', '其他'];
  const openingCategories = ['全部', ...openingCategoryValues];
  const openingCurrencies = ['不限', ...currencies];
  const openingRuleRows = [
    { ruleId: 'OR-FB-001', mediaChannel: 'Facebook', priority: '10', status: '启用', agent: 'Madhouse', accountType: 'Facebook-绿通户', countryMatch: '美国 / 加拿大 / 英国 / 法国 / 荷兰', categoryMatch: '时尚与服装 / 家居厨房与生活 / 美妆与个护', minDailyBudget: '0', maxDailyBudget: '500', dailyBudgetRange: '0 ~ 500 USD', prechargeBasePerAccount: '550.00', currency: 'USD', quoteVersion: 'RULE-20260813-A', updatedAt: '2026-08-13 11:20:18', updatedBy: owners.amLi, remark: '常规品类优先规则，审核时只锁定代理和账户类型。', ops: ['编辑', '复制', '停用', '查看详情'] },
    { ruleId: 'OR-FB-002', mediaChannel: 'Facebook', priority: '20', status: '启用', agent: 'Gimc', accountType: 'Facebook-企业户', countryMatch: '美国 / 加拿大 / 英国 / 法国', categoryMatch: '宠物用品 / 家居厨房与生活 / 时尚与服装', minDailyBudget: '0', maxDailyBudget: '800', dailyBudgetRange: '0 ~ 800 USD', prechargeBasePerAccount: '650.00', currency: 'USD', quoteVersion: 'RULE-20260813-B', updatedAt: '2026-08-13 11:18:02', updatedBy: owners.amZhao, remark: '标准企业户规则，适合常规地区和标准品类。', ops: ['编辑', '复制', '停用', '查看详情'] },
    { ruleId: 'OR-FB-003', mediaChannel: 'Facebook', priority: '30', status: '启用', agent: 'Rockads', accountType: 'Facebook-三不限', countryMatch: '美国 / 加拿大 / 英国 / 法国 / 德国', categoryMatch: '口服健康保健与营养 / 非口服健康保健与营养 / 其他', minDailyBudget: '', maxDailyBudget: '', dailyBudgetRange: '不限', prechargeBasePerAccount: '900.00', currency: 'USD', quoteVersion: 'RULE-20260813-C', updatedAt: '2026-08-13 11:08:43', updatedBy: owners.bdWang, remark: '高限制品类使用，不向客户端暴露规则明细。', ops: ['编辑', '复制', '停用', '查看详情'] },
    { ruleId: 'OR-FB-004', mediaChannel: 'Facebook', priority: '40', status: '启用', agent: 'Panda', accountType: 'Facebook-企业户', countryMatch: '荷兰 / 英国 / 法国', categoryMatch: '美妆与个护 / 时尚与服装 / 家居厨房与生活', minDailyBudget: '0', maxDailyBudget: '300', dailyBudgetRange: '0 ~ 300 USD / EUR', prechargeBasePerAccount: '650.00', currency: 'USD / EUR', quoteVersion: 'RULE-20260813-D', updatedAt: '2026-08-13 10:52:34', updatedBy: owners.bdQian, remark: '低预算欧洲投放兜底规则。', ops: ['编辑', '复制', '停用', '查看详情'] },
