...
(function () {
            ...
            customers: [
              {
                ...
                accounts: [
                  { id: '1566924120712203', name: 'HQ-W-12-13', currency: 'USD', balance: '0.01', serviceRate: 3, preTaxRate: 0 },
                  { id: '856275879259933', name: 'MX-B-07-01', currency: 'USD', balance: '24,114.05', serviceRate: 3, preTaxRate: 0 },
                  { id: '705119845658146', name: 'TL-B-12-1446', currency: 'USD', balance: '0.01', serviceRate: 3, preTaxRate: 0 },
              ...
              },
              {
                ...
                accounts: [
                  { id: '1292368695505904', name: 'MX-G-12-620', currency: 'USD', balance: '0.00', serviceRate: 3, preTaxRate: 0 },
                  { id: '1446318376445043', name: 'IT - TEST -M', currency: 'USD', balance: '120.00', serviceRate: 3, preTaxRate: 0 },
  ...
  const subtractionRows = {
    fb: [
      { orderId: 'AD20260809091211234560001', customerId: '102', customerName: 'adstest', merchantId: '1128', submitter: '管理员', submittedAt: '2026-08-09 09:12:11', accountId: '907805824316408', accountName: 'MX-B-08-729', bindCard: '否', cardSnapshot: '-', currency: 'USD', agent: 'Madhouse', amount: '120', actualAmount: '-', walletCurrency: 'USD', walletAmount: '120', status: '待处理', completedAt: '-', remark: '待媒体减款后确认钱包加回金额', ops: ['媒体已完成', '标记媒体失败', '重试', '忽略并完成'] },
  ...
  const clearRows = {
    fb: [
      { orderId: 'AD20260809101011999900001', customerId: '102', customerName: 'adstest', merchantId: '1128', submitter: '管理员', submittedAt: '2026-08-09 10:10:11', accountId: '907805824316408', accountName: 'MX-B-08-729', bindCard: '否', cardSnapshot: '-', currency: 'USD', agent: 'Madhouse', amount: '1,260.50', walletCurrency: 'USD', walletAmount: '1,260.50', status: '待处理', completedAt: '-', actualDate: '-', remark: '近2天无消耗，可发起清零', ops: ['处理成功', '媒体已完成', '标记媒体失败', '重试', '忽略并完成'] },
