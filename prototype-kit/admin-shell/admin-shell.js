...
(function () {
  ...
  const SHELL_VERSION = '20260909-opening-mail2';
  ...
  window.BESTADS_OPENING_FEE = window.BESTADS_OPENING_FEE || {
    openingFeePerAccount: 30,
    prechargePerAccount: 550,
    currency: 'USD'
  };
  window.BESTADS_OPENING_FEE_HELPERS = {
    siteFee() {
      ...
      return {
        openingFeePerAccount: Number(fee.openingFeePerAccount != null ? fee.openingFeePerAccount : fee.amount) || 0,
        prechargePerAccount: Number(fee.prechargePerAccount) || 0,
    ...
    quoteForCount(count) {
      ...
      return {
        openingFeePerAccount: fee.openingFeePerAccount,
        prechargePerAccount: fee.prechargePerAccount,
        openingFee: fee.openingFeePerAccount * n,
        precharge: fee.prechargePerAccount * n,
