...
> 生成：2026-06-09 ｜ 维护者：产品（@欧伟权）+ AI
> 数据来源：`广告系统项目概述.md`（PRD 62 篇）、`后端-ai-context/`、`前端-客户端-frontend/`、`前端-h5-frontend/`
...
| 开户 | V1.0 / V2.X | `*/openAdsAccountTask/*` | `ads_account_task`(status -1~11) | W+A |
...
> 「开发中 / 待评审 / 仅 PRD」3 项已与产品确认 @2026-06-09。
