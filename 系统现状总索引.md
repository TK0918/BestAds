...
| 📝 仅 PRD + 原型（研发未开始） | **V2.42 开户自动化**：本地 PRD `PRD/V 2.42 开户自动化.md`，运营端账户规则配置/开户管理与客户端申请开户/操作记录原型已入库（`ac20716`）；后端仍走现网开户工单，未按新报价/扣费闭环改造 |
...
> 「开发中 / 待评审 / 仅 PRD」中绑卡户、吐点 V2.23、广告自动规则引擎已与产品确认 @2026-06-09。V2.42 开户自动化为 2026-08-17 本地 PRD+原型入库，研发未开始。
