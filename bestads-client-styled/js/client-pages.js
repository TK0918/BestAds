      ...
      tabs: [
        {
          ...
          columns: ['申请ID', '媒体', '投放信息', '账户数', '最终报价', '开户费', '首充', '服务费', '预收税费费率', '钱包扣款', '状态', '操作'],
          rows: [
            {
            ...
            },
            {
              ...
              category: '宠物用品',
              currency: 'USD',
              initialQuote: '1,740.00 USD',
              openingFee: '150.00 USD',
              precharge: '1,650.00 USD',
              serviceRate: '-',
              preTaxRate: '-',
              finalQuote: '1,800.00 USD',
              walletCharge: '-',
              paymentStatus: '待客户确认',
              paymentAuth: '未自动扣款，实际扣款高于报价',
            ...
            },
            {
              ...
              currency: 'USD',
              initialQuote: '1,160.00 USD',
              openingFee: '60.00 USD',
              precharge: '1,100.00 USD',
              serviceRate: '-',
              preTaxRate: '-',
              finalQuote: '1,160.00 USD',
              walletCharge: '1,160.00 USD',
              paymentStatus: '已扣款',
              paymentAuth: '实际扣款未超过报价，已按授权自动扣款',
        ...
        },
        {
          ...
          rows: [
            ...
            ['AD-OPEN-AO20260811005-01', 'Facebook', '2026-08-11 09:33:40', '1002116215352952', 'Oliva-Amsterdam', 'EUR', '550', '533.50', { status: '完成' }, '2026-08-11 10:02:18'],
